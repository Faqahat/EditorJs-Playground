...
var i = (n, t, e) =>
  t in n
    ? c(n, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
    : (n[t] = e);
...
class a {
  constructor(t) {
    ...
    (this.api = e),
      o.colors && (this.colors = o.colors),
      o.columns && (this.columns = o.columns);
  }
  static get title() {
    return "Color";
  }
  ...
  render() {
    ...
    return (
      (t.type = "button"),
      (t.innerHTML = l),
      t.classList.add(this.api.styles.inlineToolButton),
  ...
  wrapAndColor(t, e) {
    ...
    const o = t.extractContents(),
      r = document.createElement(this.tag);
    r.classList.add(this.class),
      r.appendChild(o),
      (r.style.color = e),
      (r.innerHTML = r.textContent || ""),
      t.insertNode(r),
      this.api.selection.expandToTag(r);
  }
  renderActions() {
    const t = document.createElement("div");
    return (
      t.classList.add("editorjs__color-selector-container"),
      (t.style.gridTemplateColumns = `repeat(${this.columns}, 1fr)`),
      this.colors.forEach((e) => {
        const o = document.createElement("div");
        o.classList.add("editorjs__color-selector__container-item"),
...
export { u as ColorPickerWithoutSanitize, a as default };
